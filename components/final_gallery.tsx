...
const photos: Photo[] = [
  ...
  { src: "/images/gallery-720.jpg", alt: "Error404", layout: "h", pos: "50% 40%"},
  // { src: "/images/gallery-310.jpg", alt: "Error404", layout: "v", pos: "center" },
  { src: "/images/gallery-630.jpg", alt: "Error404", layout: "h", pos: "50% 35%" },

  { src: "/images/gallery-420.jpg", alt: "Error404", layout: "v", pos: "center" },
  ...
  { src: "/images/gallery-430.jpg", alt: "Error404", layout: "v", pos: "right" },
...
function GalleryItem({
  ...
  const aspectClass = isH ? "aspect-[3/1]" : "aspect-[3/4]"
